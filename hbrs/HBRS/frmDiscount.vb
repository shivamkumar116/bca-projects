...
Public Class frmDiscount
    ...
    Private Sub bttnSave_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles bttnSave.Click
        ...
        If a = vbYes Then
            ...
            Else
                con.Open()
                Dim rate As Integer = Val(txtRate.Text)
                rate = rate / 100
                Dim status As String = "Active"
                Dim update As New OleDbCommand("UPDATE tblDiscount SET DiscountType = '" & Trim(txtType.Text) & "',DiscountRate = '" & rate.ToString() & "' WHERE ID = '" & id & "'", con)
