...
Public Class printticket
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Transportation.printticket.rpt"
        End Get
        Set(ByVal value As String)
            'Do nothing
        End Set
...
Public Class Cachedprintticket
    Inherits Component
    ...
    <Browsable(False), _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)> _
    Public Overridable Property IsCacheable() As Boolean Implements ReportSource.ICachedReport.IsCacheable
        Get
            Return True
        End Get
        Set(ByVal value As Boolean)
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As printticket = New printticket
        rpt.Site = Me.Site
        Return rpt
    End Function
